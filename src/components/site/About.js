var aboutMe= {
	...
	text: (
		...
		As of right now, I spend a lot of time studying and building applications using [ JavaScript, Sass, SVG, Angular, ...<insert plethora of browser libraries here> ].

		I am very adept at within the browser environment and know my way around backend services and linux based servers.
		However these tools and languages are just means to an end of practicing information architecture principles and creating fluid user experiences.
		...
		Life is one big state machine, so I practice maths, software engineering, cognitive science, art, and kickboxing to get to the future I want to be in.
...
var aboutSite = {
	...
	text: (`
		...
		I am more concerned with design and style of this site, as I am going to use to demostrate the ideas I have while learning UI and UX. 
		I intend on using this as the testing ground for a few app ideas I have as well.
		...
		This site was made using Angular, jQuery, and Bootstrap's Grid for some layout. My goal is to completely separate these libraries out and just use vanilla JS. 
		`.split('\n\n'))
}
